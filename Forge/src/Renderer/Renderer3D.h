...
namespace Forge
{
    ...
    private:
        ...
        std::unordered_set<const Framebuffer*> m_ShadowFramebuffers;
    ...
    public:
        ...
        inline const PostProcessor& GetPostProcessor() const
        {
        ...
        inline const RendererStats& GetStats() const
        {
            return m_Stats;
        }
        ...
        void BeginScene(const Ref<Framebuffer>& framebuffer, const CameraData& camera,
    ...
    private:
        ...
        CameraData CreateCameraFromLightSource(const glm::vec3& lightPosition, const glm::vec3& lightDirection,
          const Ref<Framebuffer>& renderTarget, const Frustum& frustum) const;
        void GetCameraTransformsFromLightSource(
