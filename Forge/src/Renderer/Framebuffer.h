...
namespace Forge
{
    ...
    public:
        ...
        inline FramebufferTextureSpecification(
          FramebufferTextureFormat format, FramebufferTextureType type = FramebufferTextureType::Texture2D)
    ...
    public:
        ...
        inline Ref<Texture> GetColorAttachment(int index) const
        {
            FORGE_ASSERT(index >= 0 && index < m_ColorAttachments.size(), "Invalid index");
            return m_ColorAttachments[index];
        }
        inline Ref<Texture> GetDepthAttachment() const
        {
